...
export const useData = defineStore({
  ...
  actions: {
    ...
    loadCategory() {
      this.categories = ["all", ...new Set(this.data.map(e => e.category))]
    },
    sortByNumbers(value) {
      this.valueOfSortByNumbers = value
      this.data.sort((a,b) => {
        if(this.valueOfSortByNumbers === "Flest kommentarer"){
          return b.commentsLenght - a.commentsLenght
  
        } else if(this.valueOfSortByNumbers === "Minsta kommentarer"){
          return a.commentsLenght - b.commentsLenght 
  
        } else if(this.valueOfSortByNumbers === "Minst uppröster") {
          return a.upvotes - b.upvotes
          
        }else if(this.valueOfSortByNumbers === "Flest uppröster") {
