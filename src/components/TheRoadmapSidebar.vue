        ...
        <ul>
            <li v-for="categorry in arr" :key="categorry" class="flex items-center">
                <span class="mr-4  w-2 h-2 rounded-full" 
                    :class="{'bg-custom-orange': categorry === 'planerad', 'bg-custom-purple': categorry === 'pågående', 'bg-custom-blue': categorry === 'live'}">
                </span>
