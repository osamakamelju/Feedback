    ...
    <div class="max-w-lg p-6 mt-4 lg:m-auto lg:p-0">
        ...
        <form @submit.prevent="add()">
            <div class="bg-custom-white rounded-xl mt-10 p-6 pt-12 relative">
                ...
                <p class="mb-4">Lägg till en kort, beskrivande rubrik </p>
                <input v-model="feedbackData.title" class="bg-custom-light-blue w-full rounded p-2 pt-3 pb-3 mb-6" type="text" required />

                <p class="font-bold text-custom-navy">Kategori</p>
                <p class="mb-4">Välj en kategori för din feedback</p>
                ...
                <p class="mb-4">Välj en status för din feedback</p>
                ...
                <p class="font-bold text-custom-navy">Feedback Detaljer</p>
                <p class="mb-4">Inkludera eventuella specifika kommentarer om vad som bör förbättras, läggas till osv. </p>
