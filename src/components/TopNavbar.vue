...
const sortsArr = ['Flest uppröster', 'Minst uppröster', 'Flest kommentarer', 'Minsta kommentarer']
...
<template>
    <nav class="bg-custom-navy md:rounded-xl p-3 flex items-center lg:p-4 lg:pl-8 lg:pr-8 mb-6">
        ...
        <span class="hidden text-custom-white font-bold text-xl mr-10 md:inline">{{ filterByStatus('suggestion').length }} Feedbacks</span>
        <div class="flex relative">
            <span class="text-custom-white mr-2">Sortera efter:</span>
        ...
        <router-link class="ml-auto" :to="{name: 'addFeedback'}"> <Button msg="+ Lägg till feedback" /> </router-link>
    </nav>
</template>
<style>
